...
public class Navaids {
    public static final AeroObject LGA = new Navaid(Navaid.Type.VORDME, "LGA", "LA GUARDIA",
        dmsToDegrees(40, 47, 1.376),
        dmsToDegrees(-73, -52, -6.962),
        0); // we don't care about frequencies...
    public static final AeroObject BDR = new Navaid(Navaid.Type.VORDME, "BDR", "BRIDGEPORT",
        dmsToDegrees(41, 9, 38.495),
        dmsToDegrees(-73, -7, -28.188),
        0);
    public static final AeroObject MAD = new Navaid(Navaid.Type.VORDME, "MAD", "MADISON",
        dmsToDegrees(41, 18, 49.811),
        dmsToDegrees(-72, -41, -31.893),
        0);
    public static final AeroObject ORW = new Navaid(Navaid.Type.VORDME, "ORW", "NORWICH",
        dmsToDegrees(41, 33, 23.053),
        dmsToDegrees(-71, -59, -57.672),
        0);
    public static final AeroObject PVD = new Navaid(Navaid.Type.VORTAC, "PVD", "PROVIDENCE",
